...
export async function getAllArtistsCtrl(req: Request, res: Response) {
  try {
    ...
    logError("Controller error", __filename, "getAllArtistsCtrl");
    res.json({
      statusCode: 1,
...
export async function getOneArtistCtrl(req: Request, res: Response) {
  ...
  try {
    ...
    logError("Controller error", __filename, "getOneArtistCtrl");
    res.json({
      status: "fail",
      statusCode: 1,
      errorMessage: "Server error",
...
export async function getArtistSongsCtrl(req: Request, res: Response) {
  ...
  try {
    ...
    logError("Controller error", __filename, "getArtistSongsCtrl");
    res.json({
      status: "fail",
      statusCode: 1,
      errorMessage: "Server error",
...
export async function getArtistAlbumsCtrl(req: Request, res: Response) {
  ...
  try {
    ...
    logError("Controller error", __filename, "getArtistAlbumsCtrl");
    res.json({
      status: "fail",
      statusCode: 1,
      errorMessage: "Server error",
